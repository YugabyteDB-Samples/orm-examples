...
var SelectProduct = func (w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(fmt.Sprintf("finding product with product_id = %s", productId))
...
var DeleteProduct = func (w http.ResponseWriter, r *http.Request) {
	productId := mux.Vars(r)["productId"]
	fmt.Println(fmt.Sprintf("deleting product with product_id = %s", productId))
...
var UpdateProduct = func (w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(fmt.Sprintf("deleting product with product_id = %d", product.ProductId))
